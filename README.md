# Java example demo CI/CD pipeline
...
Example application and CI/CD pipeline showing how to deploy a Java website to elestio.

<img src="src\main\webapp\resources\images\screenshot-1.jpg" alt="screenshot of the example app" width="100%" />
...
But for these Java website examples, you can choose GitHub as your deployment method.

### Step 3: Authentication

If you forked the repo then you can click on the sign-in with GitHub button and authorize elestio to access the git repo then you can select the java-example repo otherwise you can directly insert a git repo URL to deploy the Java website.
